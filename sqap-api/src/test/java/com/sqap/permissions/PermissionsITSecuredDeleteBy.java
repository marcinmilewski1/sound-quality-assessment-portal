...
public class PermissionsITSecuredDeleteBy {
    ...
    public void shouldDeleteWhenIsOwnerById() throws Exception {
        ...
        testGroupRepository.doDeleteSecured(createdEntity.getId(), TestGroupEntity.class.getTypeName());
